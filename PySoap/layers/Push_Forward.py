from PySoap import get_activation_function
from PySoap.validation import check_layer
from PySoap.layers import Layer

import numpy as np


class Push_Forward(Layer):
    """ A push forward layer - Where forward propagation is defined as element wise
        multiplication of the weight with the input, and element wise addition of the bias
    ...
    def summary_(self):
        check_layer(self)
        return f'Push Forward', f'Output Shape {(None, *self.output_shape)}'
